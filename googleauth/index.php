...
$google_client_id 		= '329152879506.apps.googleusercontent.com';
$google_client_secret 	= 'RaZ247ETvDWzsDIiZ1a4CFBN';
$google_redirect_url 	= 'http://localhost/googleauth/index.php';
$google_developer_key 	= 'AIzaSyDLdQcnS5fN46mJIJ3piC7Z8q0oUWu6gsY';

########## MySql details (Replace with yours) #############
$db_username = "root"; //Database Username
$db_password = ""; //Database Password
$hostname = "localhost"; //Mysql Hostname
$db_name = 'crowdfix'; //Database Name
###################################################################
...
$gClient->setApplicationName('Login to CrowdFix');
